package com.sbx.core.swagger.autoconfigure;

import com.sbx.core.swagger.autoconfigure.properties.SwaggerProperties;
...
@ConditionalOnMissingClass("com.sbx.gateway.handler.SwaggerHandler")
